...
const Cards = () => {
  return (
    ...
    <div className={Style.card}>
      ...
      <div className={Style.card}>
      <img src="Air-Purifier.jpg" alt="Air Purifier"/>
      <div className={Style.content}>
        <h2>AIR PURIFIERS</h2>
  ...
  <div className={Style.card}>
      <img src="Air-Cooler.jpg" alt="Air Purifier"/>
      <div className={Style.content}>
        <h2>AIR COOLER</h2>
  ...
  <div className={Style.card}>
      <img src="electro.jpg" alt="Air Purifier"/>
      <div className={Style.content}>
  ...
  <div className={Style.card}>
      <img src="central.jpg" alt="Air Purifier"/>
      <div className={Style.content}>
  ...
  <div className={Style.card}>
      <img src="water.png" alt="Air Purifier"/>
      <div className={Style.content}>
        <h2>WATER COOLER</h2>
  ...
  <div className={Style.card}>
      <img src="AFTER.jpg" alt="Air Purifier"/>
      <div className={Style.content}>
  ...
  <div className={Style.card}>
      <img src="MANU.jpg" alt="Air Purifier"/>
      <div className={Style.content}>
  ...
  <div className={Style.card}>
      <img src="INTER.jpg" alt="Air Purifier"/>
      <div className={Style.content}>
  ...
  <div className={Style.card} >
      <img src="PRO.jpg" alt="Air Purifier"/>
      <div className={Style.content}>
        ...
        <a href="#">View Products →</a>
         ...
         <div className={Style.card}>
      <img src="career.jpg" alt="Air Purifier"/>
  ...
  <div className={Style.card}>
      ...
      <div className={Style.card}>
      <img src="invest.jpg" alt="Air Purifier"/>
      <div className={Style.contents}>
        <h2>INVESTORS </h2>
      ...
      <div className={Style.card}>
      <img src="social.jpg" alt="Air Purifier"/>
      <div className={Style.contents}>
        <h2>INITIVATIVES </h2>
